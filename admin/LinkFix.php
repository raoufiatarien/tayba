...
require "hash.php";  ?>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header">&emsp;Edit Link</h3>
          </div>
        </div>
        <?php
                            $field = $_GET['id'];
                                $query = 'SELECT '.$field.' FROM links LIMIT 1';
        ...
        <section class="panel">
              ...
              <div class="panel-body">
                <form class="form-horizontal" method="POST" id="service_form"  enctype="multipart/form-data" action="modify_link.php">
